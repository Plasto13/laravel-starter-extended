...
class About_Administrator_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
            ...
            <input class='imgph' type="hidden" name="<?php echo $this->get_field_name('author_image'); ?>" id="<?php echo $this->get_field_id( 'author_image' ); ?>" value="<?php echo $instance['author_image']; ?>">
