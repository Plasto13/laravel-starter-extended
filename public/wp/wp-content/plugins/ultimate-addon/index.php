...
final class Ultimate_Elementor_Extension {
	...
	public function ultimate_default_scripts(){
		wp_enqueue_style('ultimate-widgets',plugins_url( '/assets/css/widgets.css', __FILE__ ), '', '1.0.0', 'all');
		wp_enqueue_style('overwrite',   plugins_url( '/assets/css/overwrite.css', __FILE__ ), array('give-styles'), '1.1.0', 'all');
	}
