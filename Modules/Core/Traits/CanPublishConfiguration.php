...
trait CanPublishConfiguration
{
    ...
    public function publishConfig($module, $fileName)
    {
        ...
        $this->mergeConfigFrom($this->getModuleConfigFilePath($module, $fileName), strtolower("portal.$module.$fileName"));
        $this->publishes([
            $this->getModuleConfigFilePath($module, $fileName) => config_path(strtolower("portal/$module/$fileName") . '.php'),
        ], 'config');
    }
