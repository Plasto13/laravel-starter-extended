                                    ...
                                    <div class="card card-accent-info">
                                        ...
                                        <div class="card-body">
                                            @if ($permissions->count())
                                                ...
                                                @php
                                                $title = (!$permission->display_name) ? __($permission->name) : __($permission->display_name)
                                                @endphp
                                                    <div class="checkbox">
                                                        {{ html()->label(html()->checkbox('permissions[]', in_array($permission->name, $userPermissions), $permission->name)->id('permission-'.$permission->id) . ' ' . $title)->for('permission-'.$permission->id) }}
                                                    </div>
                                                @endforeach
                                            @endif
                                        </div>
