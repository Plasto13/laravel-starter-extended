                                    ...
                                    <div class="card card-accent-primary">
                                        ...
                                        <div class="card-body">
                                            @if ($permissions->count())
                                                ...
                                                @endphp
                                                    <div class="checkbox">
                                                        {{ html()->label(html()->checkbox('permissions[]', old('permissions') && in_array($permission->name, old('permissions')) ? true : false, $permission->name)->id('permission-'.$permission->id) . ' ' . $label)->for('permission-'.$permission->id) }}
                                                    </div>
                                                @endforeach
                                            @endif
                                        </div>
