...
@endswitch
    ...
    <meta property="og:title" content="@yield('title') | {{ setting('core::app_name') }}" />
    <meta property="og:site_name" content="{{setting('core::meta_site_name')}}" />
    <meta property="og:description" content="{{ setting('core::meta_description') }}" />
    <meta property="og:image" content="{{ asset(setting('core::meta_image')) }}" />
    <meta property="og:image:width" content="1200" />
    <meta property="og:image:height" content="630" />

    <!-- Twitter Meta -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:site" content="{{ setting('core::meta_twitter_site') }}">
    <meta name="twitter:url" content="{{url()->full()}}" />
    <meta name="twitter:creator" content="{{ setting('core::meta_twitter_creator') }}">
    <meta name="twitter:title" content="@yield('title') | {{ setting('core::app_name') }}">
    <meta name="twitter:description" content="{{ setting('core::meta_description') }}">
    <meta name="twitter:image" content="{{ asset(setting('core::meta_image')) }}">
